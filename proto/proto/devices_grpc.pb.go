...
const (
	...
	Devices_RenameDevice_FullMethodName   = "/proto.Devices/RenameDevice"
...
type DevicesClient interface {
	...
	RenameDevice(ctx context.Context, in *RenameDeviceReq, opts ...grpc.CallOption) (*Device, error)
	// admin only
...
func (c *devicesClient) RenameDevice(ctx context.Context, in *RenameDeviceReq, opts ...grpc.CallOption) (*Device, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Device)
	err := c.cc.Invoke(ctx, Devices_RenameDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *devicesClient) ListAllDevices(ctx context.Context, in *ListAllDevicesReq, opts ...grpc.CallOption) (*ListAllDevicesRes, error) {
	...
	err := c.cc.Invoke(ctx, Devices_ListAllDevices_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DevicesServer interface {
	...
	RenameDevice(context.Context, *RenameDeviceReq) (*Device, error)
	// admin only
...
func (UnimplementedDevicesServer) RenameDevice(context.Context, *RenameDeviceReq) (*Device, error) {
...
func (UnimplementedDevicesServer) ListAllDevices(context.Context, *ListAllDevicesReq) (*ListAllDevicesRes, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAllDevices not implemented")
}
...
func _Devices_RenameDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenameDeviceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DevicesServer).RenameDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Devices_RenameDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DevicesServer).RenameDevice(ctx, req.(*RenameDeviceReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Devices_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Devices_RenameDevice_Handler,
		},
		{
