...
export class InfoRes extends jspb.Message {
	...
	getEndpoint(): string {return jspb.Message.getFieldWithDefault(this, 18, "");
	}
	...
	static serializeBinaryToWriter(message: InfoRes, writer: jspb.BinaryWriter): void {
		...
		const field18 = message.getEndpoint();
		if (field18.length > 0) {
	...
	static deserializeBinaryFromReader(message: InfoRes, reader: jspb.BinaryReader): InfoRes {
		while (reader.nextField()) {
			...
			case 17:
				...
				break;
			case 18:
				const field18 = reader.readString()
				message.setEndpoint(field18);
				break;
			case 19:
